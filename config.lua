...
rootMenuConfig =  {
    {
        ...
        subMenus = { "expressions:normal", "expressions:drunk", "expressions:angry", "expressions:dumb", "expressions:electrocuted", "expressions:grumpy", "expressions:happy", "expressions:injured", "expressions:joyful", "expressions:mouthbreather"}
    },
    {
        id = "blips",
        displayName = "GPS",
    ...
    {
        id = "copDead",
        displayName = "Паник бутон",
        icon = "#police-vehicle-radar",
        functionName = "panicButton:start",
        enableMenu = function()
           local src = source
           return isPolice
        end,
...
},
{
    ...
    { 
        id = "general-parking",
        displayName = "Отвори Гараж",
        icon = "#vehicle-vehicleList",
        functionName = "grp-garages:GetOwnedVehicles",
        enableMenu = function()
            return not IsPedInAnyVehicle(PlayerPedId()) and exports["gambinos_garages"]:IsInsideZone('garage', PlayerPedId())
        end
    },
    { 
        id = "general-impound",
        displayName = "Наказателен",
        icon = "#vehicle-vehicleList",
        functionName = "grp-garages:GetImpoundedVehicles",
        enableMenu = function()
            return not IsPedInAnyVehicle(PlayerPedId()) and exports["gambinos_garages"]:IsInsideZone('impound', PlayerPedId())
        end
    },

    {
        id = "general-store:vehicle",
        displayName = "Паркирай",
        icon = "#vehicle-parkvehicle",
        functionName = "grp-garages:StoreVehicle",
        enableMenu = function()
            return IsPedInAnyVehicle(PlayerPedId()) and exports["gambinos_garages"]:IsInsideZone('garage', PlayerPedId())
        end
    },
    -- // Eotix Garage END \\ --
...
RegisterNetEvent("esx:setJob") -- dont edit this unless you don't use qb-core
...
end) -- ТОВА Е НАПРАВЕНО ЗА NoPixel JobManager
